...
# Import protobuf modules - Vercel Compatible
try:
    import MajoRLogin_pb2 as mLpB
    import MajorLoginRes_pb2 as mLrPb
except ImportError:
    try:
        spec1 = importlib.util.spec_from_file_location("MajoRLogin_pb2", os.path.join(os.path.dirname(__file__), "MajoRLogin_pb2.py"))
        spec2 = importlib.util.spec_from_file_location("MajorLoginRes_pb2", os.path.join(os.path.dirname(__file__), "MajorLoginRes_pb2.py"))
        if spec1 and spec2:
        ...
        print(f"ERROR loading protobuf: {e}")
        mLpB = None
        mLrPb = None
