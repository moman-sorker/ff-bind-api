...
{Colors.END}"""
    ...
    print(f"{Colors.MAGENTA}●{'═' * 15} {Colors.WHITE}{Colors.BOLD}Sarker Bind Tool {Colors.END}{Colors.MAGENTA}{'═' * 15}●{Colors.END}\n")

    print(f" {Colors.GREEN}⊛ DEVELOPER : {Colors.WHITE}M. SARKER{Colors.END}")
...
def check_bind_info(access_token=None, show_raw=False):
    ...
    try:
        ...
        nickname_raw = query_params.get("nickname", ["Unknown"])[0]
...
def owner_details():
    ...
    print(f" \033[96m⊛ Developer Name :\033[0m \033[97mM. SARKER\033[0m")
    print(f" \033[96m⊛ Tool Version   :\033[0m \033[92m(Premium / Secure)\033[0m")
